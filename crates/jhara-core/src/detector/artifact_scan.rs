...
pub fn all_manifest_hints() -> HashSet<&'static str> {
    ARTIFACT_RULES
        ...
        .chain(
            ARTIFACT_SUFFIX_RULES
                .iter()
                .flat_map(|r| r.manifest_hints.iter().copied()),
        )
        .chain(
            ARTIFACT_PREFIX_RULES
                .iter()
                .flat_map(|r| r.manifest_hints.iter().copied()),
        )
        .collect()
...
pub static ARTIFACT_RULES: &[ArtifactRule] = &[
    ...
    ArtifactRule {
        ...
        note: "Next.js build cache",
    },
    ArtifactRule {
        dir_name: ".nuxt",
        manifest_hints: &["nuxt.config.js", "nuxt.config.ts", "package.json"],
        kind: "build",
        base_confidence: 0.96,
    ...
    ArtifactRule {
        ...
        manifest_hints: &["pytest.ini", "pyproject.toml", "conftest.py"],
        kind: "test",
        base_confidence: 0.99,
        note: "pytest cache",
    },
    ArtifactRule {
        dir_name: ".mypy_cache",
        manifest_hints: &["mypy.ini", "pyproject.toml"],
        kind: "tool-cache",
        base_confidence: 0.99,
        note: "mypy cache",
    },
    ...
    ArtifactRule {
        dir_name: "_build",
        manifest_hints: &["mix.exs", "mix.lock"],
        kind: "build",
        base_confidence: 0.96,
        note: "Elixir/Erlang build",
    },
    ArtifactRule {
        dir_name: ".terraform",
        ...
        kind: "tool-cache",
        base_confidence: 0.99,
        note: "Terraform providers cache",
    },
    ArtifactRule {
        dir_name: ".stack-work",
        manifest_hints: &["stack.yaml"],
        kind: "build",
        base_confidence: 0.99,
        note: "Haskell Stack artifacts",
    },
    ArtifactRule {
        dir_name: "zig-cache",
        manifest_hints: &["build.zig"],
        kind: "build",
        base_confidence: 0.99,
    ...
    ArtifactRule {
        ...
        kind: "build",
        base_confidence: 0.99,
        note: "Zig build output",
    },
    ArtifactRule {
        dir_name: ".dart_tool",
        manifest_hints: &["pubspec.yaml"],
        kind: "tool-cache",
        base_confidence: 0.99,
        note: "Dart/Flutter pub cache",
    },
    ArtifactRule {
        dir_name: "dist",
        manifest_hints: &["package.json", "Cargo.toml", "setup.py", "pyproject.toml"],
        kind: "build",
        base_confidence: 0.83,
        note: "Distribution build output",
    },
    ArtifactRule {
        dir_name: "build",
        manifest_hints: &["package.json", "CMakeLists.txt", "Makefile", "build.gradle"],
        kind: "build",
        base_confidence: 0.75,
        note: "Generic build output",
    },
    ArtifactRule {
        dir_name: "vendor",
        manifest_hints: &["go.mod", "go.sum", "Gemfile", "composer.json"],
        kind: "deps",
        base_confidence: 0.83,
        note: "Vendored dependencies",
    },
    ArtifactRule {
        dir_name: ".nx",
        manifest_hints: &["nx.json"],
        kind: "tool-cache",
        base_confidence: 0.98,
        note: "Nx monorepo cache",
    },
    ArtifactRule {
        dir_name: "bazel-bin",
        manifest_hints: &["WORKSPACE", "MODULE.bazel"],
        kind: "build",
        base_confidence: 0.99,
        note: "Bazel compiled outputs",
    },
    ArtifactRule {
        dir_name: "bazel-out",
        manifest_hints: &["WORKSPACE", "MODULE.bazel"],
        kind: "build",
        base_confidence: 0.99,
        note: "Bazel all outputs",
    },
    ArtifactRule {
        dir_name: ".ccache",
        manifest_hints: &["CMakeLists.txt", "Makefile"],
        kind: "cc-cache",
        base_confidence: 0.98,
        note: "ccache compiler cache",
    },
    ArtifactRule {
        dir_name: "nimcache",
        manifest_hints: &[],
    ...
    ArtifactRule {
        ...
        kind: "test",
        base_confidence: 0.88,
        note: "Test coverage output",
    },
    ArtifactRule {
        dir_name: "mlruns",
        manifest_hints: &["requirements.txt"],
        kind: "ml-cache",
        base_confidence: 0.97,
        note: "MLflow experiment data",
    },
];
...
pub static ARTIFACT_SUFFIX_RULES: &[ArtifactSuffixRule] = &[
    ArtifactSuffixRule {
        suffix: ".egg-info",
        manifest_hints: &["setup.py", "pyproject.toml"],
        kind: "build",
        base_confidence: 0.98,
        note: "Python egg-info",
    },
    ArtifactSuffixRule {
        suffix: ".dist-info",
        manifest_hints: &["setup.py", "pyproject.toml"],
...
pub static ARTIFACT_PREFIX_RULES: &[ArtifactPrefixRule] = &[
    ArtifactPrefixRule {
        ...
        kind: "build",
        base_confidence: 0.99,
        note: "CMake out-of-source build",
    },
    ArtifactPrefixRule {
        prefix: "bazel-",
        manifest_hints: &["WORKSPACE"],
        kind: "build",
        base_confidence: 0.95,
        note: "Bazel build symlink",
    },
];
