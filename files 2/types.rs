...
/// | 54     |  1   | kind                |
/// | 55     |  1   | _padding            |
/// | 56     |  8   | (end — total = 56 + padding to 64)* |
///
...
pub struct ScanNodeC {
    ...
    pub kind: u8,
    /// Reserved.  Must be written as `0`; must not be read.
    pub _padding: u8,
}
...
mod tests {
    ...
    #[test]
    fn scan_node_c_size_is_56_bytes() {
        assert_eq!(mem::size_of::<ScanNodeC>(), 56);
    }
